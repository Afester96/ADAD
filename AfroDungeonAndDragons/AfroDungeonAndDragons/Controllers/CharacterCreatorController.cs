    ...
    public class CharacterCreatorController : Controller
    {
        ...
        public CharacterCreatorController()
        {
            races = new List<Race>
            {
                ...
                "ненависть к гоблинам и оркам — вот вещи, объединяющие всех дварфов.", Description="Описание", RacialTrait="Short and Stout"},
                new Race {Id=2, Name="Человек", Size=Size.Medium, Speed=30, ShortDescription="Человеки", Description="Описание", RacialTrait="Short and Stout"}
            };
        }
